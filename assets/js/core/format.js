const LABELS={
  ...
  INTERNAL:"Interno",PUBLIC:"General",COMMENT:"Comentario",SUPERVISION:"Supervisión",NOVELTY:"Novedad"
};
const ROLE_LABELS={super_admin:"Superadministrador",gerencia:"Gerencia",jefe_logistica:"Jefatura de logística",ventas:"Ventas",cartera:"Cartera",caja:"Caja",compras:"Compras",recepcion_mercancia:"Recepción de mercancía",coordinador_logistico:"Coordinación logística",aux_logistica:"Auxiliar de logística",auxiliar_corte:"Auxiliar de corte",despacho_nacional:"Despacho nacional",auditoria:"Auditoría"};
