...
export const api={
  ...
  qaFlowProgress:runId=>rpc("erp_x_qa_flow_progress",{p_run_id:runId}),
  qaFlowMatrix:(runId,status="ALL")=>rpc("erp_x_qa_flow_matrix",{p_run_id:runId,p_status:status}),
  qaFlowCaseDetail:caseId=>rpc("erp_x_qa_flow_case_detail",{p_case_id:caseId}),
  qaFlowSummary:runId=>rpc("erp_x_qa_flow_summary",{p_run_id:runId}),
  qaFlowFinish:runId=>mutationRpc("erp_x_qa_flow_finish",{p_run_id:runId}),
  qaFlowLatest:()=>rpc("erp_x_qa_flow_latest"),
  qaFlowLatestResumable:()=>rpc("erp_x_qa_flow_latest_resumable"),
  ...
  qaRobotFinishDirectedRun:(runId,suite="DIRECTED")=>mutationRpc("erp_x_qa_robot_finish_directed_run",{p_run_id:runId,p_suite:suite}),
  ...
  qaRobotBuildDeepCampaign:(runId,mode="TOTAL")=>mutationRpc("erp_x_qa_robot_build_deep_campaign",{p_run_id:runId,p_mode:mode}),
  qaRobotBuildReleaseCampaign:runId=>mutationRpc("erp_x_qa_robot_build_release_campaign",{p_run_id:runId}),
  qaRobotBuildRouteCampaign:runId=>mutationRpc("erp_x_qa_robot_build_route_campaign",{p_run_id:runId}),
  qaRobotExecuteDeepCase:caseId=>mutationRpc("erp_x_qa_robot_execute_deep_case",{p_case_id:caseId}),
  qaRobotExecuteReleaseSlice:caseId=>mutationRpc("erp_x_qa_robot_execute_release_slice",{p_case_id:caseId}),
  qaReleaseRouteMatrix:(runId=null,family="ROUTE_CANONICAL",status="ALL",search=null,page=1,pageSize=400)=>rpc("erp_x_qa_release_route_matrix",{p_run_id:runId,p_family:family,p_status:status,p_search:search,p_page:page,p_page_size:pageSize}),
  qaReleaseCaseEvidence:caseId=>rpc("erp_x_qa_release_case_evidence",{p_case_id:caseId}),
  qaReleaseFlowIntegrity:()=>rpc("erp_x_qa_release_flow_integrity"),
  qaReleaseHealth:runId=>rpc("erp_x_qa_release_health",{p_run_id:runId}),
  qaRobotTransportFailure:(caseId,error,terminal=false)=>mutationRpc("erp_x_qa_robot_transport_failure",{p_case_id:caseId,p_error:error||null,p_terminal:terminal}),
  qaRobotResetStaleCases:(runId,olderSeconds=120)=>mutationRpc("erp_x_qa_robot_reset_stale_cases",{p_run_id:runId,p_older_seconds:olderSeconds}),
  qaRobotDeepProgress:(runId,limit=24)=>rpc("erp_x_qa_robot_deep_progress",{p_run_id:runId,p_limit:limit}),
  qaRobotReleaseCertificate:runId=>rpc("erp_x_qa_robot_release_certificate",{p_run_id:runId}),
  qaRobotLatestResumable:()=>rpc("erp_x_qa_robot_latest_resumable"),
  qaCapacityRecord:payload=>mutationRpc("erp_x_qa_capacity_record",{p_payload:payload||{}}),
  qaCapacityRuns:(limit=20)=>rpc("erp_x_qa_capacity_runs",{p_limit:limit}),
  ...
  selfCheckV1022:()=>rpc("erp_x_v10_22_self_check"),
  flowIntegrity:()=>rpc("erp_x_flow_integrity"),
