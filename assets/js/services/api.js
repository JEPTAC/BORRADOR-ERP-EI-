...
export const api={
  ...
  confirmPickingRound:(orderId,payload)=>rpc("erp_x_confirm_picking_round",{p_order_id:orderId,p_payload:payload}),
  resumePartialPicking:orderId=>rpc("erp_x_resume_partial_picking",{p_order_id:orderId}),
