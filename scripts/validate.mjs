...
check(read("assets/js/config.js").includes('10.29.0-visual-premium'),"Versión visual incorrecta.");
check(read("service-worker.js").includes('10-29-0-visual-premium'),"Cache del Service Worker no corresponde a V10.29.0.");
...
check(css.includes("Sistema visual premium"),"Falta el sistema visual V10.29.0.");
...
check(read("assets/js/core/layout.js").includes("btn btn-create top-new-order"),"Nuevo pedido debe usar la familia visual de creación.");
...
console.log("VALIDACIÓN V10.29.0 CORRECTA");
