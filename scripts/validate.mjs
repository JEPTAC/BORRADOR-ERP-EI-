...
check(read("assets/js/config.js").includes('10.28.0-visual-enterprise'),"Versión visual incorrecta.");
check(read("service-worker.js").includes('10-28-0-visual-enterprise'),"Cache del Service Worker no corresponde a V10.28.0.");
...
check(css.includes("Sistema visual enterprise"),"Falta el sistema visual V10.28.0.");
...
check(css.includes('.btn-primary{')&&css.includes('.modal-overlay{')&&css.includes('.sidebar{'),"Faltan componentes visuales base.");
...
console.log("VALIDACIÓN V10.28.0 CORRECTA");
